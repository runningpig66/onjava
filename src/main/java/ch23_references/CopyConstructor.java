...
final class GreenZebra extends Tomato {
    GreenZebra() {
...
public class CopyConstructor {
    ...
    public static void ripen2(Tomato t) {
        try {
            Class c = t.getClass();
            // 将 getConstructor 改为 getDeclaredConstructor（可以获取所有权限的构造器），或者把类和构造器都改成 public。
            // Use the "copy constructor":
...
/* Output:
In ripen, t is a ch23_references.Tomato
In slice, f is a ch23_references.Fruit
java.lang.NoSuchMethodException: ch23_references.Tomato.<init>(ch23_references.Tomato)
java.lang.NoSuchMethodException: ch23_references.Tomato.<init>(ch23_references.Tomato)
In ripen, t is a ch23_references.Tomato
In slice, f is a ch23_references.Fruit
java.lang.NoSuchMethodException: ch23_references.GreenZebra.<init>(ch23_references.GreenZebra)
java.lang.NoSuchMethodException: ch23_references.GreenZebra.<init>(ch23_references.GreenZebra)
 */
