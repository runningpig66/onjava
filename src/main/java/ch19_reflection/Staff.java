 ...
 * @date 2025/12/23 周二
 * @time 15:46
 * P.629 §19.8 使用 Optional
 * <p>
 * 注意 Staff 类轻松地忽略了 Optional 的存在，尽管你知道它们在那里，保护你免受 NullPointerException 的影响：
 * <p>
 * 在某些地方可能仍然需要检查 Optional，这与检查 null 没有什么不同，
 * 但在其他地方（例如本例中的 toString() 转换）不需要进行额外的检查，可以直接假设所有的对象引用都是有效的。
 */
