 ...
 * <p>
 * 下面是一段测试 Count 的程序，同时也示范了该如何使用它。
 */
public class TestCount {
    ...
    public static void main(String[] args) {
        ...
        int[] a5 = new int[SZ];
        // Arrays.setAll(a5, new Count.Integer()::get); // Auto-unboxing
        Arrays.setAll(a5, new Count.Pint()::get);
        ArrayShow.show(a5);
        ...
        Arrays.setAll(a6, new Count.Plong()::get);
        ArrayShow.show(a6);
        ...
        Arrays.setAll(a8, new Count.Pdouble()::get);
        ArrayShow.show(a8);
